...
const Footer = () => {
  return (
    <footer className="bg-khaki-50 w-screen navbar align-elements m-0 font-color font-style flex-col xl:flex-row justify-between ">
      <aside className="hidden xl:flex flex-col justify-center">
        <NavLink
          to="/"
